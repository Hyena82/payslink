...
const SwapContent = () => {
  ...
  const [selectedValue2, setSelectedValue2] = useState({
    key: "bnb",
    label: <TokenBox name="bnb" />,
  });
  return (
    <Wrapper className="center">
      <Image
        src="/images/staking/swap-icon.svg"
        width={104}
        height={104}
        alt=""
      />

      <p className="title-box">Payslink Swap</p>

      <p className="desc-box">Trade Instantly & Pool Tokens to Earn Rewards</p>

      <Flex className="center w-100" mb={4}>
        <Box className="w-100">
          <Select
            suffixIcon={
              <Image
        ...
        <Box className="" mx={3}>
          <Image src="/images/icons/swap.svg" width={29} height={29} alt="" />
        </Box>
